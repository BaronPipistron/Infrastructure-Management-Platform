...
\newglossaryentry{infrastructureascode}{
    ...
    description={подход к описанию инфраструктурных ресурсов и конфигураций в виде кода или декларативных спецификаций, которые могут храниться в системе контроля версий и применяться автоматизированными инструментами}
}
