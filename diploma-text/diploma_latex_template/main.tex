...
\reviewer{Дзюба Дмитрий Владимирович}
...
\begin{document}
    ...
    \include{contents/02-chapter-01-theory}
    \include{contents/03-chapter-02-design}
    \include{contents/04-chapter-03-implementation}
    \include{contents/05-chapter-04-quality-evaluation}
    \include{contents/06-chapter-05-practical-approbation}
    
    \include{contents/07-conclusion} % Заключение
